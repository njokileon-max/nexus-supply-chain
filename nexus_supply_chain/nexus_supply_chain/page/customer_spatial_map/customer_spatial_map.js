// apps/nexus_supply_chain/nexus_supply_chain/page/customer_spatial_map/customer_spatial_map.js
...
frappe.pages['customer_spatial_map'].on_page_load = function(wrapper) {
    ...
    $(wrapper).find('.layout-main-section').append(`
        <style>
            ...
            /* High-End, Distinct CSS for the Company/Warehouse Marker */
            .nexus-company-marker {
                background-color: #0f172a; /* Slate 900 - Dark and professional */
                ...
                align-items: center;
                justify-content: center;
                border-radius: 10px; /* Rounded square to contrast with circular customers */
                border: 2px solid #ffffff;
                box-shadow: 0 5px 15px rgba(0, 0, 0, 0.5);
                z-index: 1000 !important; /* Keep it above everything else */
            }
    ...
    function init_spatial_map() {
        ...
        frappe.db.get_list('Company', {
            ...
            companies.forEach(comp => {
                ...
                if (c_lat && c_lng) {
                    // Note: We add the Company directly to the map, NOT the cluster group!
